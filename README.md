...
# How to Update:
The "DeployWebsite.sh"-Script should do everything that is needed to update any part of the Website. If the subdomain is also updated it is important to execute "Update_RSS.sh" first. Then IN THE SAME MINUTE start "DeployWebsite.sh", push the SubModule and run"DeployWebsite.sh" again. This is not perfect but should keep all modules updated, all links updated and keeps the current scripts working.

# Subdomain:

The Subdomain for RE//POSSESSED was moved into a SubModule because I had issues with hosting:

[https://github.com/CatWithCode/repossessed](https://github.com/CatWithCode/repossessed)

It is hosted under two Domains:

[https://repossessed.catwithcode.moe/](https://repossessed.catwithcode.moe/)

and

[https://repossessed.moe/](https://repossessed.moe/)
