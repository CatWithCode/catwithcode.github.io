...
const header_STATIC_HTML_INSERT = '<h2 id="Header_Border" align="center">  <a href="/"> <img src="/Assets/favicon.gif" alt="Cute Pixelart" style="width:55px;height:55px";></a>  <a href="/">CatWithCode</a>  <br>  <br>  <b>&nbsp;</b>  <a href="/blog.html">BLOG</a>  <b>&nbsp;</b>  <a href="/projects.html">PROJECTS</a>  <b>&nbsp;</b>  <a href="/MediaLibraries/MediaLibraries.html">LIBRARYS</a>  <b>&nbsp;</b>  <a href="/contact.html">CONTACT</a>   <b>&nbsp;</b>  <a href="/rss.html">📡&nbsp;RSS</a>  <b>&nbsp;</b></h2><div class="centredItems pixelFree banner">  <a href="https://repossessed.moe/"> <img src="/Assets/Image_Repository/Promotions/REPOSSESSED_AD.png" alt="REPOSSESSED GAME LINK"></a></div>';

// ### HARD_CODE_TRIGGER ###
// footer
// Assets/BaseFiles/Page/Footer.html
const footer_STATIC_HTML_INSERT = '<h5 id="Fooder_Border"><a href="/privacy.html">PRIVACY</a>&nbsp;&nbsp;<a href="/license.html">LICENSE</a><br>###DATE_TEXT###&nbsp;&nbsp;|&nbsp;&nbsp;©️ CatWithCode&nbsp;&nbsp;|&nbsp;&nbsp;###LICENSE###<br>&nbsp;&nbsp;Latest Build:<b>2026.06.08 - 21:58</b></h5>';
...
function WriteHeader(skipCss = false, skipBanner = false) {
    // Set's Header Bar:
    document.getElementById("Header").innerHTML = (header_STATIC_HTML_INSERT);

    // Replace Banners if needed:
    if (skipBanner) {
